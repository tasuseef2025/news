...
export async function GET() {
  ...
  const xml = `<?xml version="1.0" encoding="UTF-8"?><rss version="2.0"><channel><title>Newsroom</title><link>${absoluteUrl("/")}</link><description>Latest news and analysis</description>${items}</channel></rss>`;

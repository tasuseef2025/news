...
export const metadata: Metadata = {
  ...
  description: "Follow live football and cricket scores, upcoming fixtures, recent results, match status, teams and competitions on Novexa News.",
  alternates: { canonical: absoluteUrl("/live-scores") },
  openGraph: {
    title: `Live Football and Cricket Scores | ${siteConfig.name}`,
    description: "Follow live scores, upcoming football and cricket fixtures, and recent results on Novexa News.",

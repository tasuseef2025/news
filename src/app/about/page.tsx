...
export default function AboutPage() {
  return (
    <StaticPage title="About Novexa News" description="Novexa News is a modern digital news platform built to make reliable information accessible across technology, business, finance, world news, sports, entertainment, health and lifestyle.">
      ...
      <p><a href="/author/novexa-news-desk"><strong>Novexa News Desk</strong></a> is the byline used for collaborative newsroom coverage: stories drafted with the help of an AI writing assistant from verified source material and reviewed, fact-checked and approved by a member of our editorial team before publication. Full detail on how this works is in our <a href="/editorial-policy">Editorial Policy</a>.</p>
    </StaticPage>
  );
}
